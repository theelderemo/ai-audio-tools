...
![free](https://img.shields.io/badge/free-1a4731?style=flat-square)
![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square)
![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square)
![api](https://img.shields.io/badge/API-0d2b45?style=flat-square)
![open-source](https://img.shields.io/badge/open--source-4a2800?style=flat-square)
![enterprise](https://img.shields.io/badge/enterprise-2a1a55?style=flat-square)
![vst](https://img.shields.io/badge/VST-1a3d3d?style=flat-square)
![hardware](https://img.shields.io/badge/hardware-2e2e2e?style=flat-square)
![acquired](https://img.shields.io/badge/acquired-1c1c1c?style=flat-square)

---

## Creation & Production

- [VRS/A](https://vrsa.app) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - AI-powered lyric writing and music production workstation with multi-model Ghostwriter, Suno integration via browser extension, audio analysis, album art generation, and VRSA Studio (studio.vrsa.app) for a dedicated production environment.
- [Suno](https://suno.com/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Generative AI music creation platform that allows users to create full songs, including vocals and instrumentation, from text prompts.
- [Soundry AI](https://soundry.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - AI for Musicians, by Musicians.
...
- [Tape It](https://tape.it/) ![free](https://img.shields.io/badge/free-1a4731?style=flat-square) - App for songwriting & audio recording.
- [sessionwire](http://sessionwire.com) ![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square) - All-in-one online collaboration platform that delivers a seamless studio experience.
...
- [Audio Design Desk](https://add.app) ![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square) - The Audio Solution for Video Editors.
- [Never Before Heard Sounds](https://heardsounds.com) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - A music studio powered by AI.
- [NeuralDSP](https://neuraldsp.com) ![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square) ![vst](https://img.shields.io/badge/VST-1a3d3d?style=flat-square) - Empowers music players by democratizing the access to world-class sound, through an intuitive software/hardware ecosystem.
- [Neutone](https://neutone.space/) ![free](https://img.shields.io/badge/free-1a4731?style=flat-square) ![vst](https://img.shields.io/badge/VST-1a3d3d?style=flat-square) - AI audio plugin & community bridging the gap between AI research and creativity.
- [Udio](https://www.udio.com) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - AI music generator with full song creation from text prompts, integrated lyric editor, and granular line-by-line vocal control.
- [Mureka](https://www.mureka.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - AI music generation with style-reference input, vocal timbre selection, and voice cloning for demos and song prototyping.
- [Soundverse](https://soundverse.ai) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Full-suite AI music studio with text-to-song, beat generation, stem separation, and SAAR — a voice-controlled music production assistant.
- [ACE Studio](https://acestudio.ai) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - All-in-one AI music studio with expressive AI vocals, natural-sounding AI instruments, and a DAW bridge for Logic, Ableton, and FL Studio.
- [Stable Audio](https://stability.ai/stable-audio) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Text-to-audio and audio-to-audio generation for music and sound effects from Stability AI, trained on licensed datasets.
- [Riffusion](https://www.riffusion.com/) ![free](https://img.shields.io/badge/free-1a4731?style=flat-square) ![open-source](https://img.shields.io/badge/open--source-4a2800?style=flat-square) - Diffusion model-based real-time music generation from text prompts, operating directly on audio spectrograms.
- [LoudMe](https://loudme.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Text-to-music generator for royalty-free songs and instrumentals with style and mood controls.
- [Ecrett Music](https://ecrettmusic.com/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Scene and mood-based AI background music generator aimed at video and content creators requiring instant scoring.
...
- [AudioShake](https://www.audioshake.ai) ![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square) ![api](https://img.shields.io/badge/API-0d2b45?style=flat-square) - An On-Demand Stem Creation Platform for the Music Industry.
- [Audionamix](https://audionamix.com/) ![enterprise](https://img.shields.io/badge/enterprise-2a1a55?style=flat-square) - Audio separation solutions for the entertainment industry.
- [vocali.se](https://vocali.se/en) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Separate vocals and music from any song, in seconds.
- [lalal.ai](https://www.lalal.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - High-quality stem splitting based on the world's #1 AI-powered technology.
- [VocalRemover](https://vocalremover.org/) ![free](https://img.shields.io/badge/free-1a4731?style=flat-square) - Separate voice from music out of a song free with powerful AI algorithms.
...
- [SONOTELLER](https://sonoteller.ai) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - AI music analysis tool for song lyric summarization, theme extraction, and musical feature identification.
- [Musicful](https://musicful.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - AI-powered music recommendation and discovery engine focused on contextual and emotional matching.
- [Harmix](https://harmix.ai/) ![api](https://img.shields.io/badge/API-0d2b45?style=flat-square) - AI music search with natural language, videos, similar audio and lyrics. Auto-tagging for audio and video.
...
- [Wavepaths](https://wavepaths.com) ![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square) - Music for Psychedelic Therapy.
- [Suki](https://www.suki.ai/) ![enterprise](https://img.shields.io/badge/enterprise-2a1a55?style=flat-square) - AI-powered voice solutions for healthcare.
...
- [SimonSays](https://www.simonsaysai.com/) ![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square) - Edit Video 5x Faster, Built For Teams.
...
- [Ava](https://www.ava.me) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Professional and AI-Based Captions for Deaf and HoH (Transcription & Diarization).
- [verbit](https://verbit.ai/) ![enterprise](https://img.shields.io/badge/enterprise-2a1a55?style=flat-square) - Professional AI-Based Transcription & Captioning.
- [otter](https://otter.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Everything hybrid teams need for productive, collaborative meetings.
- [Trint](https://trint.com/) ![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square) - Audio Transcription Software — Speech to Text to Magic.
- [Rev](https://rev.com) ![paid](https://img.shields.io/badge/paid-5c1a1a?style=flat-square) - 99% accurate captions, transcripts, and subtitles.
- [voiceitt](https://voiceitt.com/) - An app for people with non-standard speech.
- [deepgram.com](https://deepgram.com/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) ![api](https://img.shields.io/badge/API-0d2b45?style=flat-square) - Better voice applications with faster, more accurate transcription through AI Speech Recognition.
- [fireflies.ai](https://fireflies.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - AI assistant for your meetings.
- [SoapBox](https://www.soapboxlabs.com/) ![api](https://img.shields.io/badge/API-0d2b45?style=flat-square) ![enterprise](https://img.shields.io/badge/enterprise-2a1a55?style=flat-square) - Speech technology that makes kids heard.
- [Amberscript](https://www.amberscript.com/en/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - SaaS solutions that automatically transform audio and video into text and subtitles using speech recognition.
- [Speaksee](https://speak-see.com/) - Live captions what's being said during in-person group meetings.
- [Speechmatics](https://www.speechmatics.com/) ![api](https://img.shields.io/badge/API-0d2b45?style=flat-square) ![enterprise](https://img.shields.io/badge/enterprise-2a1a55?style=flat-square) - Autonomous Speech Recognition technology that understands every voice.
- [sonix](https://sonix.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) - Automated transcription in 35+ languages.
- [Picovoice](https://picovoice.ai/) ![freemium](https://img.shields.io/badge/freemium-4a3500?style=flat-square) ![api](https://img.shields.io/badge/API-0d2b45?style=flat-square) ![open-source](https://img.shields.io/badge/open--source-4a2800?style=flat-square) - End-to-end Edge Voice AI, on-device voice recognition.
...
- [Quilio](https://www.quilio.dev/) ![api](https://img.shields.io/badge/API-0d2b45?style=flat-square) - We maintain tools to help developers build real-time audio AI applications with ease.
